...
{
    public class Create1bppImageWithErrorDiffusion
    {
        public Create1bppImageWithErrorDiffusion()
        {
        }
        /// <summary>
        ...
        /// 
            public static Bitmap Create1bppImageWithErrorDiffusionfunction(Bitmap img)
        {
            //1bppイメージを作成する
